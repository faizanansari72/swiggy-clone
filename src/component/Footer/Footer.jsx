  ...
  return (
    <div className='footer'>
      ...
      <div className="footer-icon">
        <div className="owner">
          <h4 style={{color: "white"}}>Faizan Ansari</h4>
        </div>
        <div className="copyright">
          <p>@Copyright2023 By  Faizan Ansari || All rights reserved</p>
        </div>
        <div className="social-icon">
          <div className="insta">
            <a href="https://www.instagram.com/its_hunk_1/"><BsInstagram style={{color: "white"}}/></a>
          </div>
          <div className="linkedin">
            <a href="https://www.linkedin.com/in/erfaizanansari/"> <BsLinkedin style={{color: "white"}} /> </a>
          </div>
          <div className="github">
            <a href="https://github.com/faizanansari72"> <BsGithub style={{color: "white"}} /> </a>
          </div>
          {/* <div className="twitter">
            <a href="https://twitter.com/mukeemul"> <BsTwitter style={{color: "white"}} /> </a>
          </div> */}
        </div>
      </div>
    </div>
